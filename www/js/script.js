...
class DataApp {
  ...
  async createGrafic() {
    ...
    for (let element of _pots) {
      ...
      <div class="card-flap flap1" style="text-align: center;margin-bottom:10px;">
        <div class="card-description">
  ...
  async createAllCharts() {
    ...
    for (let element of _pots) {
      ...
      lineLuminosidad[diaDeLaSemana] = this.calcularPorcentajeLux(informationPots.brightness);
  ...
  calcularPorcentajeLux(lux) {

    var porcentaje = (lux / 1450) * 100;
    return porcentaje;
